...
public class NumeroCinco extends AppCompatActivity {

    private ImageButton button;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_numero_cinco);
    ...
    public void openActivitynumeroseis() {
        Intent intent = new Intent(this, NumeroSeis.class);
        startActivity(intent);
